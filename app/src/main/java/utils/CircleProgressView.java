...
//        mPaint.setColor(Color.rgb(0xe9, 0xe9, 0xe9));
        mPaint.setColor(getResources().getColor(R.color.circle_bg));
        ...
        mPaint.setColor(getResources().getColor(R.color.main_font_color));
        ...
        canvas.drawText(text, width / 2 - textWidth / 2, height / 2 + textHeight / 5, mPaint);
